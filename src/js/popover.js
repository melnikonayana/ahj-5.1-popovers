export default class Popover {
    ...
    pos() {
        ...
        this.element.style.left = `${window.scrollX + left + this.targetElement.offsetWidth / 2 - this.element.offsetWidth / 2}px`;
        this.element.style.top = `${window.scrollY + top - this.element.offsetHeight - 8}px`;
    }
